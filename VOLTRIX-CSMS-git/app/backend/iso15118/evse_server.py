...
class EVSEServer:
    ...
    # WebSocket sunucusunu başlatır ve bağlantıları dinlemeye başlar.
    ...
    # EV bağlantısı kurulduğunda gelen mesajları dinler ve işler.
    ...
    # EV'den gelen mesajları ayrıştırır ve ilgili işleyici metoda yönlendirir.
    ...
    # EV'den gelen bağlantı isteğine olumlu yanıt verir.
    ...
    # EV'nin batarya bilgilerini içeren yanıtı gönderir.
    ...
    # EV'den gelen şarj başlatma isteğini işler ve CSMS'e bildirir.
    ...
    # EV'den gelen şarj durdurma isteğini işler ve CSMS'e bildirir.
    ...
    # Şarj başlangıç bilgisini CSMS tarafına OCPP üzerinden iletir.
    ...
    # Şarj durdurma bilgisini CSMS tarafına OCPP üzerinden iletir.
    ...
    # Geçerli UTC zamanını ISO formatında döner.
    def _timestamp(self):
