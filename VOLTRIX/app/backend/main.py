...
async def lifespan(app):
    ...
    logger.info("Lifespan startup tamamlandı.")
    yield  # ⬅ FastAPI server burada başlar
...
def update_evse_status(index: int, payload: dict):
    """Update EVSE status and reflect reservation status."""
